...
class Phoenix_WirecardCheckoutPage_Model_Epaybg extends Phoenix_WirecardCheckoutPage_Model_Abstract
{  
    /**   
    ...
    * @var string [a-z0-9_]   
    **/
    protected $_code = 'wirecard_checkout_page_epaybg';
    protected $_paymentMethod = 'EPAY_BG';
}
?>