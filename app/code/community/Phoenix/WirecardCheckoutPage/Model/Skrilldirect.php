...
class Phoenix_WirecardCheckoutPage_Model_Skrilldirect extends Phoenix_WirecardCheckoutPage_Model_Abstract
{  
    /**   
    ...
    * @var string [a-z0-9_]   
    **/
    protected $_code = 'wirecard_checkout_page_skrilldirect';
    protected $_paymentMethod = 'SKRILLDIRECT';
}
