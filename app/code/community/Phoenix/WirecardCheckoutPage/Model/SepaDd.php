...
class Phoenix_WirecardCheckoutPage_Model_SepaDd extends Phoenix_WirecardCheckoutPage_Model_Abstract
{  
    /**   
    ...
    * @var string [a-z0-9_]   
    **/
    protected $_code = 'wirecard_checkout_page_sepadd';
    protected $_paymentMethod = 'SEPA-DD';
}