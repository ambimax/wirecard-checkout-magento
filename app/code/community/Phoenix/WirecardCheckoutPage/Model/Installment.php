...
class Phoenix_WirecardCheckoutPage_Model_Installment extends Phoenix_WirecardCheckoutPage_Model_Abstract
{
    /**
    ...
    * @var string [a-z0-9_]
    **/
    protected $_code = 'wirecard_checkout_page_installment';
    ...
    public function assignData($data)
    {
        ...
        $key = 'wirecard_checkout_page_installment_dob';
        if (is_array($data)) {
    ...
    /**
     * (non-PHPdoc)
     * @see Phoenix_WirecardCheckoutPage_Model_Abstract::getCustomerDob()
     */
    public function getCustomerDob()
    {
        $additionalInfo = $this->getInfoInstance();
        if($additionalInfo->hasAdditionalInformation('wirecard_checkout_page_installment_dob'))
        {
            $dob = $additionalInfo->getAdditionalInformation('wirecard_checkout_page_installment_dob');
            if($dob)
            {
