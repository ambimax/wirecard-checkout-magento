...
class Phoenix_WirecardCheckoutPage_Block_Additional_InvoiceB2b extends Mage_Core_Block_Template
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('wirecard_checkout_page/additional/invoiceb2b.phtml');
    }
