...
class Phoenix_WirecardCheckoutPage_Block_Additional_Invoice extends Mage_Core_Block_Template
{

    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('wirecard_checkout_page/additional/invoice.phtml');
    }
