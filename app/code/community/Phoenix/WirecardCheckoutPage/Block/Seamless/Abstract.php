...
class Phoenix_WirecardCheckoutPage_Block_Seamless_Abstract extends Mage_Core_Block_Template
{
    ...
    {
        $data = Mage::getSingleton('core/session')->getWirecardCheckoutPagePaymentInfo();
        if ($data)
        {
            return $data;
        }
