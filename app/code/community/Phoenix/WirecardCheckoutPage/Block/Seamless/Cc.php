...
class Phoenix_WirecardCheckoutPage_Block_Seamless_Cc extends Mage_Payment_Block_Form_Cc
{
    ...
    {
        return Mage::getStoreConfigFlag('payment/wirecard_checkout_page_cc/show_issue_date', Mage::app()->getStore()->getId());
    }

    public function showIssueNumber()
    {
        return Mage::getStoreConfigFlag('payment/wirecard_checkout_page_cc/show_issue_number', Mage::app()->getStore()->getId());
    }

	public function showCardholder()
	{
		return Mage::getStoreConfigFlag('payment/wirecard_checkout_page_cc/show_cardholder', Mage::app()->getStore()->getId());
	}

	public function showCvc()
	{
		return Mage::getStoreConfigFlag('payment/wirecard_checkout_page_cc/show_cvc', Mage::app()->getStore()->getId());
	}
