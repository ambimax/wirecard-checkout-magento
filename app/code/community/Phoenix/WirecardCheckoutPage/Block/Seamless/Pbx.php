...
class Phoenix_WirecardCheckoutPage_Block_Seamless_Pbx extends Phoenix_WirecardCheckoutPage_Block_Seamless_Abstract
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('wirecard_checkout_page/seamless/pbx.phtml');
    }
}