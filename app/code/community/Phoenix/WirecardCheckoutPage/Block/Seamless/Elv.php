...
class Phoenix_WirecardCheckoutPage_Block_Seamless_Elv extends Phoenix_WirecardCheckoutPage_Block_Seamless_Abstract
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('wirecard_checkout_page/seamless/elv.phtml');
    }
}