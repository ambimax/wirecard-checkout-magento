...
class Phoenix_WirecardCheckoutPage_Block_WirecardCheckoutPagecheckout extends Mage_Core_Block_Template
{
    /**
    ...
    public function getIframeUrl()
    {
        ...
        {
            $redirectUrl = $session->getWirecardCheckoutPageRedirectUrl();
        }
        else
        {
            try
