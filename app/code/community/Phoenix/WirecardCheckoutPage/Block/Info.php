...
class Phoenix_WirecardCheckoutPage_Block_Info extends Mage_Payment_Block_Info
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('wirecard_checkout_page/info.phtml');
    }
    ...
    {
        $this->setTemplate('wirecard_checkout_page/pdf/info.phtml');
        return $this->toHtml();
    }
}
?>